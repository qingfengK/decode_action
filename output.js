//Thu Sep 25 2025 06:53:56 GMT+0000 (Coordinated Universal Time)
...
(async () => {
  ...
  for (let _0x1e33c9 = 0; _0x1e33c9 < _0x492613.length; _0x1e33c9++) {
    ...
    const _0x5a2498 = _0x492613[_0x1e33c9].split("#")[0],
      _0x4820a4 = _0x492613[_0x1e33c9].split("#")[1];
    ...
    if (_0x5baa1c.data.status) {
      ...
      if (_0x5baa1c.data.data.signStatus != 1) {
        const _0x22201b = new Date().getTime(),
          _0x54cecb = await sendPostRequest("https://webapi2.qmai.cn/web/cmk-center/sign/takePartInSign", _0x5a2498, {
            activityId: "947079313798000641",
            appid: appid,
            storeId: 49006,
            timestamp: _0x22201b,
...
function sgin(_0x1087f2, _0x5bd9de) {
  var _0x49e9d7 = "947079313798000641",
    _0xd658cd = 49006,
    _0x2bbdf0 = _0xd658cd ? _0xd658cd.toString() : undefined,
    _0x1998a8 = {
    ...
    _0x2808d1 = Object.keys(_0x1998a8).sort(),
    _0x20a740 = _0x2808d1.reduce(function (_0x24a310, _0x32f0dc) {
      _0x24a310[_0x32f0dc] = _0x1998a8[_0x32f0dc];
      return _0x24a310;
    }, {}),
    _0x1f4e2c = Object.entries(_0x20a740).map(function (_0x37fab7) {
      var [_0xabea89, _0x5a0789] = _0x37fab7;
      return _0xabea89 + "=" + _0x5a0789;
    }).join("&") + "&key=" + _0x49e9d7.split("").reverse().join(""),
    _0x148766 = CryptoJS.MD5(_0x1f4e2c).toString(CryptoJS.enc.Hex).toUpperCase();
  return _0x148766;
}
function Env(_0x384062, _0x19e9a1) {
  ...
  return new class {
    ...
    loaddata() {
      ...
      }
      {
        ...
        const _0x31dd59 = this.path.resolve(this.dataFile),
          _0x37a875 = this.path.resolve(process.cwd(), this.dataFile),
          _0x2bca6e = this.fs.existsSync(_0x31dd59),
          _0x241667 = !_0x2bca6e && this.fs.existsSync(_0x37a875);
    ...
    writedata() {
      if (this.isNode()) {
        ...
        const _0x267811 = this.path.resolve(this.dataFile),
          _0x5be9f2 = this.path.resolve(process.cwd(), this.dataFile),
          _0x2358a6 = this.fs.existsSync(_0x267811),
          _0x5deef0 = !_0x2358a6 && this.fs.existsSync(_0x5be9f2),
          _0x551581 = JSON.stringify(this.data);
    ...
    lodash_get(_0x17292e, _0x17d77e, _0x5eabac) {
      ...
      for (const _0x286e23 of _0x57c3ce) if (_0x566416 = Object(_0x566416)[_0x286e23], void 0 === _0x566416) {
        return _0x5eabac;
      }
      return _0x566416;
    }
    ...
    getdata(_0x4a4c98) {
      ...
      if (/^@/.test(_0x4a4c98)) {
        const [, _0x57d065, _0x269895] = /^@(.*?)\.(.*?)$/.exec(_0x4a4c98),
          _0xdd9c59 = _0x57d065 ? this.getval(_0x57d065) : "";
        if (_0xdd9c59) {
          try {
    ...
    setdata(_0x33c3f1, _0x1120c9) {
      ...
      if (/^@/.test(_0x1120c9)) {
        const [, _0x331977, _0x110c59] = /^@(.*?)\.(.*?)$/.exec(_0x1120c9),
          _0x554b51 = this.getval(_0x331977),
          _0x235edc = _0x331977 ? "null" === _0x554b51 ? null : _0x554b51 || "{}" : "{}";
        try {
    ...
    setval(_0x3de221, _0x1fe115) {
      return this.isSurge() || this.isLoon() ? $persistentStore.write(_0x3de221, _0x1fe115) : this.isQuanX() ? $prefs.setValueForKey(_0x3de221, _0x1fe115) : this.isNode() ? (this.data = this.loaddata(), this.data[_0x1fe115] = _0x3de221, this.writedata(), !0) : this.data && this.data[_0x1fe115] || null;
    }
    initGotEnv(_0x5b5324) {
      this.got = this.got ? this.got : require("got");
      this.cktough = this.cktough ? this.cktough : require("tough-cookie");
      this.ckjar = this.ckjar ? this.ckjar : new this.cktough.CookieJar();
      _0x5b5324 && (_0x5b5324.headers = _0x5b5324.headers ? _0x5b5324.headers : {}, void 0 === _0x5b5324.headers.Cookie && void 0 === _0x5b5324.cookieJar && (_0x5b5324.cookieJar = this.ckjar));
    }
        ...
        if ("object" == typeof _0x3a7db3) {
          if (this.isLoon()) {
            let _0xf3d12d = _0x3a7db3.openUrl || _0x3a7db3.url || _0x3a7db3["open-url"],
              _0x1d1319 = _0x3a7db3.mediaUrl || _0x3a7db3["media-url"];
            return {
              openUrl: _0xf3d12d,
              mediaUrl: _0x1d1319
            };
          ...
          if (this.isQuanX()) {
            let _0x26fa5d = _0x3a7db3["open-url"] || _0x3a7db3.url || _0x3a7db3.openUrl,
              _0x7bbbc6 = _0x3a7db3["media-url"] || _0x3a7db3.mediaUrl;
            return {
              "open-url": _0x26fa5d,
              "media-url": _0x7bbbc6
            };
    ...
    wait(_0x233f01) {
      ...
      const _0x26bcd3 = new Date().getTime(),
        _0x291844 = (_0x26bcd3 - this.startTime) / 1000;
...
function checkVersion(_0x4eb942, _0x2a03f8) {
  try {
    ...
    const _0x4ad3bc = SyncRequest("GET", "https://bus.yxrong.cn/api/update/check?fileName=" + _0x4eb942 + "&fileMd5=" + _0x2a03f8),
      _0x2ecd3f = JSON.parse(_0x4ad3bc.getBody("utf8"));
