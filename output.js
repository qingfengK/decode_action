//Wed Aug 28 2024 11:35:43 GMT+0000 (Coordinated Universal Time)
...
function bdy_0x2ee552(_0x50a8f1, _0x59d6c0, _0x1738d0) {
  let _0x37dfdf = bdy_0x2b6b51[_0x50a8f1];
...
async function bdy_0x57852c() {
  ...
  _0xd22a01 && (_0x4b36b7.t = _0x21becf);
  _0x52291f && (_0x4b36b7.clientVersion = _0x52291f);
  _0x3d4502 && (_0x4b36b7.client = _0x3d4502);
  let _0x166f6b = _0x4b36b7,
    _0x5a167a = ["appid", "body", "client", "clientVersion", "functionId", "t"],
    _0x5cf746 = _0x5a167a.filter(_0x77da4a => _0x4b36b7[_0x77da4a]).map(_0x39c394 => _0x39c394 + ":" + (_0x39c394 == "body" ? bdy_0x2dc142.SHA256(_0x4b36b7[_0x39c394]).toString() : _0x4b36b7[_0x39c394])).join("&"),
